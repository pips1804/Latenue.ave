...
<!-- <div class="sidebar" id="mySidebar">
    <div class="side-header">
        <img src="../bg-logo-img/logo.jpg" width="120" height="120" alt="" class="admin-profile">
        <h5 style="margin-top:10px;">Hello, Admin</h5>
    </div>

    <hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    <a href="javascript:void(0)" class="closebtn" onclick="">×</a>
...
<div class="sidebar" id="mySidebar" style="background-color:#6C4E31 ;">
    ...
    <hr style="border:1px solid; background-color:#FFDBB5; border-color:#3B3131;">
