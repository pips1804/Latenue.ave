<div id="ordersBtn">
    <p class="section-title">Pending Orders</p>
    <div class="scrollable-table">
        <table class="table" style="width: 80vw;">
            ...
            $sql = "SELECT * from view_pending_orders";
            ...
            ?>
                    <tr>
                        ...
                        ?>
                            <td><button class="btn btn-danger" onclick="ChangeToProcessing('<?= $row['order_id'] ?>')">Pending </button></td>
                        <?php

                        } elseif ($row["order_status"] == 1) {
                        ?>
                            <td><button class="btn btn-warning" onclick="ChangeToProcessing('<?= $row['order_id'] ?>')">Processing</button></td>
                        <?php
                        } elseif ($row["order_status"] == 2) {
                        ?>
                            <td><button class="btn btn-info" onclick="ChangeToProcessing('<?= $row['order_id'] ?>')">Shipped</button></td>
                        <?php
                        } elseif ($row["order_status"] == 3) {
                        ?>
                            <td><button class="btn btn-success" onclick="ChangeToProcessing('<?= $row['order_id'] ?>')">Delivered</button></td>
                        <?php
                        } elseif ($row["order_status"] == 4) {
                        ?>
                            <td><button class="btn btn-success" onclick="ChangeToProcessing('<?= $row['order_id'] ?>')">Cancelled</button></td>
                        <?php
                        }
                        if ($row["pay_status"] == 0) {
                        ?>
