...
if ($row["order_status"] == 0) {
     ...
     $update = mysqli_query($conn, "UPDATE orders SET order_status=2 where order_id='$order_id'");
} else if ($row["order_status"] == 2) {
     $update = mysqli_query($conn, "UPDATE orders SET order_status=3 where order_id='$order_id'");
